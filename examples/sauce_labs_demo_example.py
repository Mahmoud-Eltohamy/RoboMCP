"""
Sauce Labs Demo App Example with AI Integration for MCP Appium
=============================================================

This module demonstrates how to use the MCP Appium implementation with AI integration
to test the Sauce Labs Demo App for Android. It combines both the basic Appium
functionality and advanced AI-powered features for natural language testing.
"""
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description='Sauce Labs Demo App Example with AI Integration')
    ...
    parser.add_argument(
        '--app',
        help='Path to the Sauce Labs Demo App (.apk)',
        default=os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), 
                             'app_tests', 'sauce_labs_demo', 'sauce_labs_demo.apk')
    )
...
def get_capabilities(app_path: str) -> Dict[str, Any]:
    """
    Get the desired capabilities for the Sauce Labs Demo App.
    
    Args:
        app_path: Path to the app APK
    ...
    if app_path and os.path.exists(app_path):
        ...
        logger.info(f"Using app at: {app_path}")
    else:
        # Fallback to app package and activity if the APK is not found
        logger.warning(f"App path {app_path} not found, using package and activity instead")
...
def main():
    """Run the Sauce Labs Demo App example."""
    try:
        args = parse_args()
        ...
        # Get capabilities
        capabilities = get_capabilities(args.app)
